 ...
 */
class EosHomeMountProvider implements IHomeMountProvider
{
    /**
     * @var IConfig
     */
    ...
    public function getHomeMountForUser(IUser $user, IStorageFactory $loader) {
        ...
        return new MountPoint('\OC\Files\EosStore\HomeEosStoreStorage', '/' . $user->getUID(), $config['arguments'], $loader);
    }
